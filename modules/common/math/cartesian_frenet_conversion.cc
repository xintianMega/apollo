...
const double rtheta, const double rkappa, const double rdkappa, const double x, const double y,
...
double CartesianFrenetConverter::CalculateTheta(const double rtheta,d const double rkappa,
...
const double theta, const double rkappa, const double kappa, const double rdkappa, const double l) {
  ...
  if (std::isinf(res)) {
    AWARN << "result is inf when calculate second order lateral derivative. input values are rtheta:"
    << rtheta << " theta: " << theta << ", rkappa: " << rkappa << ", kappa: " << kappa << ", rdkappa: "
    << rdkappa << ", l: " << l << std::endl;
  }
  return res;
}
