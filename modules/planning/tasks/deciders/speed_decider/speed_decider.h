...
class SpeedDecider : public Task {
 ...
 private:
  ...
  STLocation GetSTLocation(const PathDecision* const path_decision, const SpeedData& speed_profile,
  ...
  bool CreateStopDecision(const Obstacle& obstacle, ObjectDecisionType* const stop_decision, double stop_distance) const;
